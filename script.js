...
function updateValue() {
  ...
  var qsolh = 0.7*awindows*238*0.75*0.75;
  ...
  var ntotlpg=nhggas*nhewater*nhdnetheat*nhs;
  var ntotgas=nhggas*nhewater*nhdnetheat*nhs;
  ...
  //koszt
  var prcoal = 3.6*1.5*qkcoal/wcoal;
  var prlpg = 3.6*0.56*2.9*qklpg/wlpg;
  var prgas = 0.20*qkgas;
  
  var prnetcogen = 0.169*qknet;
  var prnetplant = 0.05191*3.6*qknet;

  var prhpww = qkhpww*0.75;
  var prhpgw = qkhpgw*0.75;
  var prhpaw = qkhpaw*0.75;
  var prhpbw = qkhpbw*0.75;
  var prel = qkel*0.75;

  var prwood = 3.6*3*qkwood/wwood;
  var prpelet = 3.6*3*qkpelet/wwood;
  var proil = 3.6*0.83*7.04*qkoil/woil;
